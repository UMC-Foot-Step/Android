...
import com.footstep.dangbal.kotlin.databinding.ActivityGalleryinfoBinding
import com.footstep.dangbal.kotlin.src.main.gallery.info.models.PostInfoResponse
import com.footstep.dangbal.kotlin.src.main.postupdate.PostUpdateActivity
...
//                                    showCustomToast("게시글 삭제취소")
    ...
    override fun onGetPostInfoSuccess(response: PostInfoResponse) {
        ...
        supportFragmentManager.beginTransaction().replace(com.footstep.dangbal.kotlin.R.id.galleryinfo_frm, GalleryInfoFragment(this, response.result, posting_id)).commitAllowingStateLoss()
